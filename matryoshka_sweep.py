#!/usr/bin/env python
"""
Matryoshka SAE training script for hyperparameter sweeps.
...
def main():
    ...
    SAVE_DIR = Path(MODEL_DIR) / "matryoshka" / f"layer_{LAYER}" / wandb.run.id
    ...
    # Group fractions - sweep parameter
    # Format: list of 5 floats that should sum to 1.0
    # Default from config: [0.03125, 0.09375, 0.21875, 0.46875, 0.1875]
