#!/usr/bin/env python
"""
Basic SAE training for ESM3-open embeddings.

Trains a standard ReLU SAE on pre-extracted ESM3-small-open (1.4B) embeddings.
...
def main():
    ...
    SAVE_DIR = Path(MODEL_DIR) / "esm3_relu" / f"layer_{LAYER}"
    ...
    print("=" * 60)
    print("ESM3-open SAE Training - ReLU")
    print("=" * 60)
    ...
    wandb_cfg = WandbConfig(
        ...
        wandb_name=f"esm3_relu_layer{LAYER}",
        log_steps=100,
    )
